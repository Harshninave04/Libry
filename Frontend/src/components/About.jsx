  ...
  return (
    <>
      ...
      <div className='bg-orange-50 dark:bg-black'>
        <div className="bg-orange-50 dark:bg-black 2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 mt-12">
          <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
            <div className="w-full lg:w-6/12">
              ...
              <p className="font-normal text-base leading-6 text-gray-600 mt-6">
                ...
                collection of books. Whether you're looking for free literature or premium titles,
                our platform offers personalized recommendations tailored to your interests. With a
                user-friendly interface, seamless browsing experience, and secure payment options
                for paid content, Libry makes it easy to find your next great read. Explore books
                across all genres, from fiction and non-fiction to self-help and academic texts.
                Join a community of book lovers and embark on your literary journey with Libry,
                where every book you discover brings a new adventure.
              </p>
            </div>
            <div className="w-full lg:w-6/12">
              <img
          ...
          <div className="relative mt-24">
            ...
            <hr className="z-10 absolute top-2/4 w-full bg-black dark:bg-gray-200" />
          </div>
          <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
            <div>
              ...
              <p className="font-normal text-base leading-6 text-gray-600 mt-6">
                I Harsh Ninave, the visionary behind Libry, is a dedicated computer science
                undergrad with a passion for building and exploring. I combined my technical skills
                with a love for books, I created Libry to provide a comprehensive platform for book
                enthusiasts to discover and enjoy a wide array of literature.
              </p>
            </div>
            <div>
              <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-black dark:text-white mt-6">
          ...
          <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
            <div className="w-full lg:w-6/12">
              <h2 className="font-bold lg:text-4xl text-3xl lg:leading-9 leading-7 text-black dark:text-white">
                Our Mission
              </h2>
              <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">
                At Libry, our mission is to revolutionize the way people discover, access, and
                engage with literature. We are committed to promoting a reading culture by providing
                easy access to a diverse collection of books, inspiring more people to embrace
                reading as a lifelong habit. Through personalized recommendations, seamless browsing
                experiences, and secure access to premium content, we empower readers to find books
                they love, ensuring that everyone can explore and enjoy literature.
              </p>
              <p className="font-normal text-base leading-6 text-gray-600 w-full lg:w-10/12 xl:w-9/12 mt-10">
                ...
                their work to reach a global audience, connecting authors directly with their
                readers. Join us in our mission to make reading more accessible, enjoyable, and
