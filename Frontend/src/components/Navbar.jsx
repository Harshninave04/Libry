    ...
    <div
      ...
      <div className="navbar text-black dark:text-white">
        <div className="navbar-start ">
          ...
          <a className="btn btn-ghost text-2xl dark:text-white">Libry</a>
        </div>
        <div className="navbar-end space-x-6">
          ...
          <div className="hidden md:block">
            <label className="input input-bordered flex items-center justify-end gap-2 bg-orange-50 dark:text-white dark:bg-black dark:border-white">
